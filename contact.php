...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $mail->setFrom('sender@andrew.io');
            $mail->addAddress('recipient@andrew.io');
...
<?php else : ?>
    ...
    <form method="post" id="formContact">
        ...
        <div class="form-group">
            ...
            <textarea rows="8" cols="10" class="form-control" name="message" id="message" placeholder="Message"><?= htmlspecialchars($message) ?></textarea>
        </div>
        <br />
